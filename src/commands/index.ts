...
export const commands: Record<string, () => CommandOutput> = {
  ...
  "resume": () => ({
    lines: [
      ...
      { text: "" },
      { text: "  Opening Resume.pdf side-pane viewer...", color: "white" },
      { text: "  If the PDF is not displaying, you can view or download it here:", color: "dim" },
      { text: "  /Resume.pdf", color: "cyan" },
      { text: "" },
    ],
  }),
